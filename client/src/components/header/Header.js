  ...
  return (
    ...
    <Component className="navComp">
      <Container>
          ...
          <h3 style={{wordSpacing:5, textDecoration:'underline'}}>Welcome {account.name}, Let's check Your BMI today</h3>
          <img style={{borderRadius:10, height: 45}} src={logo} alt=""  />
        <MobileMenu anchor="left" open={menuOpen} onClose={toggleMenu}>
          <List>
            ...
            <ListItem  component={Link} to="/progress" onClick={toggleMenu}>
              <ListItemIcon>
                <TrendingUpIcon />
              </ListItemIcon>
              <ListItemText primary="BMI journey" />
            </ListItem>
